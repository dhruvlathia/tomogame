      ...
      <div className="max-w-4xl mx-auto p-8">
        <header className="flex justify-between items-center mb-12">
          ...
          <button
            ...
            className="px-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors text-sm font-medium shadow-sm"
          >
            Sign Out
          </button>
        </header>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-white/10 rounded-2xl p-6 hover:border-blue-500/30 transition-colors group cursor-pointer shadow-sm dark:shadow-none">
          ...
          <div className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-white/10 rounded-2xl p-6 hover:border-purple-500/30 transition-colors group cursor-pointer shadow-sm dark:shadow-none">
