        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-6 group">
              <div className="w-8 h-8 bg-linear-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center shadow-lg shadow-blue-500/20 group-hover:scale-110 transition-transform">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-sm">
              The ultimate platform for testing friendships. Create quizzes,
              share with friends, and discover who knows you best.
            </p>
          </div>
